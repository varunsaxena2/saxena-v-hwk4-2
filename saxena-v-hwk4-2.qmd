...
#library(ggbeeswarm)
```
https://github.com/varunsaxena2/saxena-v-hwk4-2
```{r}
#| echo: false
...
q92
```
The lower premium HMO-based plan appears to have a higher overall rating than the higher premium PPO alternative plan. Additionally, the fee-for-service PFFS plan apears to have the lowest customer satisfaction of all.
\newpage
\noindent 10.
